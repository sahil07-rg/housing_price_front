...
const downloadReport = () => {
  ...
  doc.setTextColor(140, 120, 94);

  doc.text(
    "Generated by Sahil Kumar",
    20,
    280
  );

  doc.save(
    "housing-intelligence-report.pdf"
  );
};
  return (
...
<button
  ...
  className="block mt-6 border border-[#d4af37] px-8 py-4 text-[#d4af37] tracking-[0.3em] hover:bg-[#d4af37] hover:text-black transition-all duration-500"
>
